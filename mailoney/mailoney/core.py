...
250 DSN\n'''
    ...
    def _handle_client(self, client_socket: socket.socket, addr: Tuple[str, int]) -> None:
        ...
        try:
            # Send banner
            banner = f"220 {self.server_name} ESMTP VNPT-Mail\r\n"
...
def display_banner() -> None:
    ...
    banner = f"""
    ****************************************************************
    *   A Simple SMTP Honeypot -VNPT - Version: {__version__}    *
    ****************************************************************
    """
    print(banner)
